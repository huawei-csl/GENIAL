...
main_pipeline() {
    ...
    run_python_script $SRC_DIR/src/genial/training/mains/trainer_enc_to_score_value.py \
        ...
        --model_checkpoint_path $WORK_DIR/output/multiplier_4bi_8bo_permuti_allcells_notech/$OUT_DIR/trainer_out/lightning_logs/version_0/checkpoints/114_0.0491_000.ckpt
