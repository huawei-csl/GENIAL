...
# Set input variables
INITIAL_OUT_DIR="15k_random_sampling"
RUN_TYPE_SUFFIX="wo_ssl_2000_epochs"
NB_PROTOTYPES=15000
DEVICE_ID=0
CONFIG_FILE="model_config_sample_w_cls_n_vae_ft_nossl.yml"
TASK="enc_to_score"
...
main_pipeline() {
    ...
    run_python_script $SRC_DIR/src/genial/training/mains/trainer_enc_to_score_value.py \
        ...
        --trainer_task $TASK \
        # --model_checkpoint $WORK_DIR/output/multiplier_4bi_8bo_permuti_allcells_notech/$OUT_DIR/trainer_out/lightning_logs/version_0/checkpoints/114_0.0491_000.ckpt
