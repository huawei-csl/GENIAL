...
RUN_TYPE_SUFFIX="sinkhorn_new_loss_2"
NB_PROTOTYPES=8192
DEVICE_ID=0
CONFIG_FILE="model_config_sample_EMB_w_cls_n_novae_ft.yml"
TASK="finetune_from_ssl"
# SSL_CHECKPOINT="trainer_out/lightning_logs/version_0/checkpoints/114_0.0491_000.ckpt"
SSL_CHECKPOINT="trainer_out/lightning_logs/version_0/checkpoints/117_0.0102_000.ckpt"
...
main_pipeline() {
    ...
    # Generate prototypes
    run_python_script $SRC_DIR/src/genial/utils/prototype_generator_EMB.py \
        --experiment_name multiplier_4bi_8bo_permuti_allcells_notech \
