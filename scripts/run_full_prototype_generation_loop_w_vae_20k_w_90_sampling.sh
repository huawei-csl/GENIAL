...
RUN_TYPE_SUFFIX="main_method_w_90_sampling"
NB_PROTOTYPES=20000
DEVICE_ID=0
...
main_pipeline() {
    ...
    # Uniformly sample
    run_python_script $SRC_DIR/src/genial/utils/sample_output_dir.py \
        --experiment_name multiplier_4bi_8bo_permuti_allcells_notech \
        --output_dir_name "temp_dir" \
    ...
    # Delete temp dir
    rm -r $WORK_DIR/output/multiplier_4bi_8bo_permuti_allcells_notech/temp_dir
