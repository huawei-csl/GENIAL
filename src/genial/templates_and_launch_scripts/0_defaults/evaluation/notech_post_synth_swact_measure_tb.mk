...
ifneq ("$(wildcard $(CWD)/../hdl/primitives_necessary_only.v)","")
  VERILOG_SOURCES += $(CWD)/../hdl/primitives_necessary_only.v
endif
...
ifeq ($(SIM),icarus)
    ...
    # COMPILE_ARGS += -DSIMULATION -DFUNCTIONAL
	  COMPILE_ARGS += -Wno-SELRANGE -Wno-WIDTH -Wno-CASEINCOMPLETE -Wno-MODDUP  -Wno-IMPLICIT
