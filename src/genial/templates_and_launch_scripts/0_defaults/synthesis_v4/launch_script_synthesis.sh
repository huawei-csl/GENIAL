...
### Fixed files
mv /app/tmp/launch_synth_flow_v4.sh $WORK_DIR/launch_synth_flow_v4.sh
...
cd $WORK_DIR
chmod +x ./launch_synth_flow_v4.sh

# sleep infinity
./launch_synth_flow_v4.sh > full_synth_flow.log
...
# Get launcher seeds (not used for synth_v4)
...
cp $FLOWY_DIR/output/db/synthesis_v4/analysis/seed_analysis/best_seeds/best_seeds.json $OUTPUT_DIR/nb_trans_and_seeds.json
...
# sleep infinity
touch $OUTPUT_DIR/synth_version_4
