...
cp $WORK_DIR/hw/mydesign/tests/results_uniform_rand_db.csv /app/tmp/synth_results/.
cp $WORK_DIR/hw/mydesign/tests/results_normal_rand_db.csv /app/tmp/synth_results/.
cp $WORK_DIR/hw/mydesign/tests/results_fullsweep_db.csv /app/tmp/synth_results/.
