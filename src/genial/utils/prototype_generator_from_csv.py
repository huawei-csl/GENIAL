...
def do_prototype_generation_main(dir_config: ConfigDir, model_workers_kwargs: dict[Any]) -> list[Path]:
    ...
    out_encoding = {
        ...
        -21: '11101011', -20: '11101100', -18: '11101110', -16: '11110000', -15: '11110001', -14: '11110010',
        -12: '11110100', -10: '11110110', -9: '11110111', -8: '11111000', -7: '11111001', -6: '11111010',
        -5: '11111011', -4: '11111100', -3: '11111101', -2: '11111110', -1: '11111111', 0: '00000000', 1: '00000001',
        2: '00000010', 3: '00000011', 4: '00000100', 5: '00000101', 6: '00000110', 7: '00000111', 8: '00001000',
        9: '00001001', 10: '00001010', 12: '00001100', 14: '00001110', 15: '00001111', 16: '00010000', 18: '00010010',
        20: '00010100', 21: '00010101', 24: '00011000', 25: '00011001', 28: '00011100', 30: '00011110', 32: '00100000',
        35: '00100011', 36: '00100100', 40: '00101000', 42: '00101010', 48: '00110000', 49: '00110001', 56: '00111000',
        64: '01000000'
    }
...
def main():
    ...
    if args_dict.get("do_prototype_pattern_gen", False):
        do_prototype_generation_main(dir_config=dir_config, model_workers_kwargs={})
